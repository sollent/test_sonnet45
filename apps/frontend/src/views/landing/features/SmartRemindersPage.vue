      ...
      <div class="container">
        <div class="hero-content">
          <div class="hero-text fade-in-up">
            ...
            <h1>Напоминания, которые <span class="gradient-text">не забудешь</span></h1>
            <p class="lead">
    ...
    <section class="feature-cta">
      <div class="container">
        <div class="cta-card animated-gradient">
          ...
          <p>Настройте умные напоминания и забудьте о пропущенных задачах</p>
          <div class="cta-actions">
            <button class="btn-white btn-large" @click="tryReminders">
              <i class="pi pi-bell"></i>
              Начать бесплатно
            </button>
