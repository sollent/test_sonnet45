 ...
 *
 * The parent::__construct($registry, Tag::class) in the repository requires
 ...
 *
 * TagRepository contains 8 complex query methods:
 * - findUserTags()
 * - findByNameAndUser()
 * - findOrCreateByNames()
 * - searchTags()
 ...
 * - updateUsageCounts()
 *
 * See: tests/Integration/Repository/TagRepositoryTest.php (to be created)
 */
