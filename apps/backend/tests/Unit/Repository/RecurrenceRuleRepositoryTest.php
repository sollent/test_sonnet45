 ...
 *
 * The parent::__construct($registry, RecurrenceRule::class) in the repository requires
 ...
 *
 * See: tests/Integration/Repository/RecurrenceRuleRepositoryTest.php (to be created)
 */
class RecurrenceRuleRepositoryTest extends TestCase
{
    /** @test */
