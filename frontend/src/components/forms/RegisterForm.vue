...
async function handleSubmit(): Promise<void> {
  ...
  try {
    ...
    const errorMessage = error?.response?.data?.message || error?.message || t('errors.registration_failed')
  ...
  <form class="register-form" @submit.prevent="handleSubmit">
    <div class="form-group">
      ...
      <InputText
        ...
        type="email"
        :placeholder="t('auth.register_subtitle')"
      ...
      >
        <template #footer>
          <div class="password-strength">
            <p class="password-strength__title">Password requirements:</p>
    ...
    <div class="form-group">
      ...
      />
      <small v-if="errors.confirmPassword" class="form-error">
...
.password-strength__list li::before {
  content: '✓';
  margin-right: 0.5rem;
  color: var(--success);
  font-weight: 700;
...
.form-actions {
  animation: slideUp 0.4s ease-out 0.4s;
  animation-fill-mode: both;
}
