 ...
 *
 * The parent::__construct($registry, MediaObject::class) in the repository requires
 ...
 *
 * See: tests/Integration/Repository/MediaObjectRepositoryTest.php (to be created)
 */
